    ...
    async (t: Omit<Transaction, "id">) => {
      ...
      const { data, error } = await supabase
        ...
        .insert({
          ...
          tags: t.paid ? Array.from(new Set([...(t.tags ?? []), "pago"])) : (t.tags ?? []).filter(tg => tg !== "pago"),
        })
        .select()
        .single();
      if (error) {
  ...
  const updateTransaction = React.useCallback(
    async (id: string, patch: Partial<Omit<Transaction, "id">>) => {
      ...
      if (patch.paid !== undefined) {
        ...
        dbPatch.tags = patch.paid 
          ? Array.from(new Set([...tags, "pago"]))
          : tags.filter(tg => tg !== "pago");
      }
